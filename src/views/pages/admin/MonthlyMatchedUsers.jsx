...
const MonthlyMatchedUsers = () => {
  const monthlyMatchedUsers = useSelector((x) => x.user.monthlyMatches)
  ...
  const [filteredMatches, setFilteredUsers] = useState(monthlyMatchedUsers)
  ...
  useEffect(() => {
    console.log('dau', monthlyMatchedUsers)
  })
  return (
    <>
...
export default MonthlyMatchedUsers
